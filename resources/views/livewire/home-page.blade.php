...
{{-- Hero Section Start --}}
<div class="w-full h-screen bg-gradient-to-r from-indigo-50 via-indigo-100 to-blue-100 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    <!-- Grid -->
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">ShopHeX</span></h1>
      ...
      <div class="relative ms-4 mt-30">
        <img class="w-full rounded-md" src="https://static.vecteezy.com/system/resources/previews/051/683/947/non_2x/an-open-laptop-with-shopping-cart-and-credit-card-free-png.png" alt="Image Description">
