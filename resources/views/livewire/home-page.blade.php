...
{{-- Hero Section Start --}}
<div class="w-full min-h-screen bg-gradient-to-r from-indigo-50 via-indigo-100 to-blue-100 py-14 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      ...
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">
          Start your journey with <span class="text-blue-600">ShopHeX</span>
        </h1>
        ...
        <div class="mt-7 grid gap-3 w-full sm:inline-flex">
          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700" href="/register">
            Get started
          </a>

          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50" href="/contact">
            Contact sales team
          </a>
        </div>
      ...
      <!-- Image -->
      <div class="relative ms-4 mt-32 ">
        <img class="w-full rounded-md"
        src="https://static.vecteezy.com/system/resources/previews/051/683/947/non_2x/an-open-laptop-with-shopping-cart-and-credit-card-free-png.png">
      </div>
  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        Discover electronics from the most trusted brands in the world.
      </p>
  ...
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
      ...
      <div class="bg-white rounded-lg shadow-md">
        <img src="https://i.pinimg.com/originals/a0/97/c3/a097c3c89b6d9a14f52f9515395d5220.png" class="object-cover w-full h-64 rounded-t-lg">
        <div class="p-5 text-center">
          <p class="text-2xl font-bold text-gray-900">Apple</p>
        </div>
      </div>

      <!-- Samsung -->
      <div class="bg-white rounded-lg shadow-md">
        <img src="https://i.pinimg.com/originals/1d/35/83/1d35833251dec0ad373ad7cbbbf4f3e2.png" class="object-cover w-full h-64 rounded-t-lg">
        <div class="p-5 text-center">
          <p class="text-2xl font-bold text-gray-900">Samsung</p>
        </div>
      </div>

      <!-- Sony -->
      <div class="bg-white rounded-lg shadow-md">
        <img src="https://logoeps.com/wp-content/uploads/2013/05/sony-corporation-vector-logo.png" class="object-cover w-full h-64 rounded-t-lg">
        <div class="p-5 text-center">
          <p class="text-2xl font-bold text-gray-900">Sony</p>
        </div>
      </div>

      <!-- Asus -->
      <div class="bg-white rounded-lg shadow-md">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtoTToPS13vpgVrhaVr_bxpYzfS3kNkgcRwQ&s" class="object-cover w-full h-64 rounded-t-lg">
        <div class="p-5 text-center">
          <p class="text-2xl font-bold text-gray-900">Asus</p>
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
          ...
          <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 17, SEP , 2023
          </p>
        </div>
      ...
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
          ...
          <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 17, SEP , 2024
          </p>
        </div>
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem cupiditate similique,
