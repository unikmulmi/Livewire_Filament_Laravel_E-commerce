          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <ul>
              ...
              <li class="mb-4">
                <label for="" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" class="w-4 h-4 mr-2">
                  <span class="text-lg dark:text-gray-400">Razer</span>
                </label>
              </li>
              <li class="mb-4">
                <label for="" class="flex items-center dark:text-gray-300">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">रु 1000</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">रु 500000</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
              <div class="border border-gray-300 dark:border-gray-700">
                <div class="relative bg-gray-200">
                  <a href="/products/product_detail" class="">
                    <img src="https://static.vecteezy.com/system/resources/thumbnails/068/696/102/small/floating-black-t-shirt-mockup-on-soft-peach-background-high-quality-apparel-template-for-fashion-design-branding-print-on-demand-clothing-promotion-and-e-commerce-product-display-photo.jpg" alt="" class="object-cover w-full h-56 mx-auto ">
                  </a>
                </div>
                <div class="p-3 ">
